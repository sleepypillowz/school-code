				...
				<div class="column-4 menu">
					<div class="border-subjects">
						...
						<div class="row">
							<div class="column-12">
								<ul>
									<li class="subject"><?php echo $Programming1Title ?></li>
									<li><?php echo $Programming1Topic1 ?></li>
									<li><?php echo $Programming1Topic2 ?></li>
									<li><?php echo $Programming1Topic3 ?></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="column-4 menu">
					<div class="border-subjects">
						...
						<div class="row">
							<div class="column-12">
								<ul>
									<li class="subject"><?php echo $Programming2Title ?></li>
									<li><?php echo $Programming2Topic1 ?></li>
									<li><?php echo $Programming2Topic2 ?></li>
									<li><?php echo $Programming2Topic3 ?></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="column-4 menu">
					<div class="border-subjects">
						...
						<div class="row">
							<div class="column-12">
								<ul>
									<li class="subject"><?php echo $Programming3Title ?></li>
									<li><?php echo $Programming3Topic1 ?></li>
									<li><?php echo $Programming3Topic2 ?></li>
									<li><?php echo $Programming3Topic3 ?></li>
								</ul>
							</div>
						</div>
					</div>
